...
client.on('message', message => {
  ...
  if (message.author.id !== "405215218453446668") return;
...
client.on("message", message => {
    if (message.content === (prefix + "help")) {
     const embed = new Discord.RichEmbed() 
         ...
         .setDescription(`**
         ------------------------------
         *+bc : برودكاست لجميع اعضاء السيرفر بايمبد
         *+bcv : برودكاست لجميع اعضاء السيرفر بدون ايمبد
         *+bcx : برودكاست للاعضاء  الاونلاين فقط
         ------------------------------
         *+id : عرض ملفك الشخصي
...
if (message.content === '_inv') {
      message.author.send('https://discordapp.com/oauth2/authorize?client_id=540204920570249216&permissions=2146958847&scope=bot').catch(e => console.log(e.stack));
...
client.on('message', message => {
   ...
   let embed = new Discord.RichEmbed()
    let args = message.content.split(' ').slice(1).join(' ');
if(message.content.split(' ')[0] == prefix + 'c1') {
    if (!args[1]) {
return;
}
...
let embed = new Discord.RichEmbed()
let args = message.content.split(' ').slice(1).join(' ');
if(message.content.split(' ')[0] == prefix + 'bcv') {
...
client.on("message", message => {
            ...
            if (message.content.startsWith(prefix + "bcx")) {
                         if (!message.member.hasPermission("ADMINISTRATOR"))  return;
  let args = message.content.split(" ").slice(1);
  var argresult = args.join(' '); 
...
client.login('NTQwMjA0OTIwNTcwMjQ5MjE2.DzTNTg.FJqtmMcTLrg_OQgEpEIFXAp2GTo');